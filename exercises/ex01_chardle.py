...
if special_word[0] == single_character:
    print(single_character + " found at index 0")
    count = (count + 1)

if special_word[1] == single_character:
    print(single_character + " found at index 1")
    count = (count + 1)

if special_word[2] == single_character:
    print(single_character + " found at index 2")
    count = (count + 1)

if special_word[3] == single_character:
    print(single_character + " found at index 3")
    count = (count + 1)

if special_word[4] == single_character:
